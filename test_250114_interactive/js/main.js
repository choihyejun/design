$(document).ready(function(){
    ...
    */
     ...
     *     vf_area_gap = 2000(vf_end) - 1000(vf_start)
    ...
    */
    ...
    function video_fixed(){
        ...
        vf_end = vf_area_name.offset().top + vf_area_name.height() - window_h + (window_h*0.1)
        ...
        if(scrolling < vf_start){
            ...
            if(vf_resize_w > vf_resize_end){ ///end값 이상 늘어나지 못하게 막음
    ...
    * .scroll_event .event_wrap .photo h2의 transform:translateY() 값을 조절해서 계속 위로 이동
    ...
    */
    ...
    $(window).resize(function(){ //리사이즈될때마다
        scroll_event()
    })
