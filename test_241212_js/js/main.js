$(document).ready(function(){
    ...
    $('.box_btn').on('click', function(){
         //box_btn을 감사하다가 click하는 순간에 실행
         $('.box').addClass('red')
    })
    /*  box_btn2를 클릭하면 box에 red라는 클래스를 추가해줌 */
...
/* =은 할당연산자 
   ...
   let bbb = '2'
console.log(abc)
console.log(bbb) // 변수는 따옴표로 감싸면 그건 그냥 글자가 됨
// 브라우저의 콘솔창에 로그 메세지를 출력해줘...
// abc라고하는 변수에 담겨 있는 메세지
...
num2 = 22
sum = num1 + num2
console.log(sum) // 33출력

sum = --num2
console.log(sum) // 21출력
